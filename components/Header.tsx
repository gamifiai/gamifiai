        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex-shrink-0">
            <a href="#" className="flex items-center">
                <img src={logoUrl} alt="GAMIFIA Logo" className="h-10" />
            </a>
          </div>
